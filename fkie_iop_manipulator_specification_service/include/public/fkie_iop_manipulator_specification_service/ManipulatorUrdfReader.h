...
typedef ReportManipulatorSpecification::JointNamesList JointNamesList;
typedef JointNamesList::JointNameRec JointName;
...
namespace iop
{
	...
	public:
		...
		* can be accessed by getJointNames() */
		...
		ReportManipulatorSpecifications& getJausMsg();
	...
	protected:
		...
		ReportManipulatorSpecifications p_jaus_msg;
