...
#include "urn_jaus_jss_manipulator_PanTiltSpecification/InternalEvents/InternalEventsSet.h"
...
#include "PanTiltSpecification_ReceiveFSM_sm.h"
...
namespace urn_jaus_jss_manipulator_PanTiltSpecification
{
	...
	class DllExport PanTiltSpecification_ReceiveFSM : public JTS::StateMachine
	{
	public:
		PanTiltSpecification_ReceiveFSM(std::shared_ptr<iop::Component> cmp, urn_jaus_jss_core_Events::Events_ReceiveFSM *pEvents_ReceiveFSM, urn_jaus_jss_core_Transport::Transport_ReceiveFSM *pTransport_ReceiveFSM);
		virtual ~PanTiltSpecification_ReceiveFSM();
		...
		PanTiltSpecification_ReceiveFSMContext *context;
