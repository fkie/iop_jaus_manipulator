...
namespace urn_jaus_jss_manipulator_PanTiltMotionProfileService
{
	...
	PanTiltMotionProfileService_ReceiveFSM::PanTiltMotionProfileService_ReceiveFSM(std::shared_ptr<iop::Component> cmp, urn_jaus_jss_core_AccessControl::AccessControl_ReceiveFSM *pAccessControl_ReceiveFSM, urn_jaus_jss_core_Events::Events_ReceiveFSM *pEvents_ReceiveFSM, urn_jaus_jss_core_Transport::Transport_ReceiveFSM *pTransport_ReceiveFSM)
	...
	void PanTiltMotionProfileService_ReceiveFSM::setupIopConfiguration()
	{
