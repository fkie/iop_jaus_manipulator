...
namespace urn_jaus_jss_manipulator_PanTiltSpecificationService
{
	...
	PanTiltSpecificationService_ReceiveFSM::PanTiltSpecificationService_ReceiveFSM(std::shared_ptr<iop::Component> cmp, urn_jaus_jss_core_Events::Events_ReceiveFSM *pEvents_ReceiveFSM, urn_jaus_jss_core_Transport::Transport_ReceiveFSM *pTransport_ReceiveFSM)
	...
	void PanTiltSpecificationService_ReceiveFSM::setupIopConfiguration()
	{
	...
	std::pair<moveit_msgs::msg::JointLimits, moveit_msgs::msg::JointLimits> PanTiltSpecificationService_ReceiveFSM::getLimits()
	{
