...
#ifndef PANTILTSPECIFICATIONSERVICEPLUGIN_H
#define PANTILTSPECIFICATIONSERVICEPLUGIN_H
...
class DllExport PanTiltSpecificationServicePlugin : public PluginInterface
{
public:
	PanTiltSpecificationServicePlugin();

	JTS::Service* get_service();
	void create_service(JTS::JausRouter* jaus_router);

protected:
	urn_jaus_jss_manipulator_PanTiltSpecificationService::PanTiltSpecificationServiceService *p_my_service;
