...
namespace urn_jaus_jss_manipulator_PanTiltMotionProfile
{
	...
	void PanTiltMotionProfile_ReceiveFSM::setupIopConfiguration()
	{
		...
		cfg.declare_param<double>("joint1_max_speed", joint1_max_speed, true,
								  rcl_interfaces::msg::ParameterType::PARAMETER_DOUBLE,
								  "Maximal speed of first joint.",
								  "Default: 1.5");
		cfg.declare_param<double>("joint1_max_accel", joint1_max_accel, true,
								  rcl_interfaces::msg::ParameterType::PARAMETER_DOUBLE,
								  "Maximal acceleration of first joint.",
								  "Default: 1.5");
		cfg.declare_param<double>("joint1_max_decel", joint1_max_decel, true,
								  rcl_interfaces::msg::ParameterType::PARAMETER_DOUBLE,
								  "Maximal deceleration of first joint.",
								  "Default: 1.5");
		cfg.declare_param<double>("joint2_max_speed", joint2_max_speed, true,
								  rcl_interfaces::msg::ParameterType::PARAMETER_DOUBLE,
								  "Maximal speed of second joint.",
								  "Default: 1.5");
		cfg.declare_param<double>("joint2_max_accel", joint2_max_accel, true,
								  rcl_interfaces::msg::ParameterType::PARAMETER_DOUBLE,
								  "Maximal acceleration of second joint.",
								  "Default: 1.5");
		cfg.declare_param<double>("joint2_max_decel", joint2_max_decel, true,
								  rcl_interfaces::msg::ParameterType::PARAMETER_DOUBLE,
