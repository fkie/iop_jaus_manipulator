...
#include "urn_jaus_jss_manipulator_PanTiltMotionProfile/PanTiltMotionProfile_ReceiveFSM.h"
#include "urn_jaus_jss_manipulator_PanTiltSpecification/PanTiltSpecificationService.h"
#include <algorithm>
    ...
    : logger(cmp->get_logger().get_child("PanTiltMotionProfileService"))
{
     ...
     */
    context = new PanTiltMotionProfile_ReceiveFSMContext(*this);
...
PanTiltMotionProfile_ReceiveFSM::~PanTiltMotionProfile_ReceiveFSM()
{
    delete context;
}

void PanTiltMotionProfile_ReceiveFSM::setupNotifications()
{
    ...
    registerNotification("Receiving_Ready_NotControlled", pAccessControl_ReceiveFSM->getHandler(), "InternalStateChange_To_AccessControl_ReceiveFSM_Receiving_Ready_NotControlled", "PanTiltMotionProfile_ReceiveFSM");
    registerNotification("Receiving_Ready_Controlled", pAccessControl_ReceiveFSM->getHandler(), "InternalStateChange_To_AccessControl_ReceiveFSM_Receiving_Ready_Controlled", "PanTiltMotionProfile_ReceiveFSM");
    registerNotification("Receiving_Ready", pAccessControl_ReceiveFSM->getHandler(), "InternalStateChange_To_AccessControl_ReceiveFSM_Receiving_Ready", "PanTiltMotionProfile_ReceiveFSM");
    registerNotification("Receiving", pAccessControl_ReceiveFSM->getHandler(), "InternalStateChange_To_AccessControl_ReceiveFSM_Receiving", "PanTiltMotionProfile_ReceiveFSM");
}
void PanTiltMotionProfile_ReceiveFSM::setupIopConfiguration()
{
    PanTiltSpecificationService* spec_srv = static_cast<PanTiltSpecificationService*>(cmp->get_service("PanTiltSpecificationService"));
    if (spec_srv != NULL) {
        p_joint_limits_current = spec_srv->pPanTiltSpecification_ReceiveFSM->getLimits();
    } else {
    ...
    joint2_max_accel = 1.5;
    joint2_max_decel = 1.5;
    iop::Config cfg(cmp, "PanTiltMotionProfileService");
    cfg.param<double>("joint1_max_speed", joint1_max_speed, joint1_max_speed, true,
        rcl_interfaces::msg::ParameterType::PARAMETER_DOUBLE,
        "Maximal speed of first joint.",
        "Default: 1.5");
    cfg.param<double>("joint1_max_accel", joint1_max_accel, joint1_max_accel, true,
        rcl_interfaces::msg::ParameterType::PARAMETER_DOUBLE,
        "Maximal acceleration of first joint.",
        "Default: 1.5");
    cfg.param<double>("joint1_max_decel", joint1_max_decel, joint1_max_decel, true,
        rcl_interfaces::msg::ParameterType::PARAMETER_DOUBLE,
        "Maximal deceleration of first joint.",
        "Default: 1.5");
    cfg.param<double>("joint2_max_speed", joint2_max_speed, joint2_max_speed, true,
        rcl_interfaces::msg::ParameterType::PARAMETER_DOUBLE,
        "Maximal speed of second joint.",
        "Default: 1.5");
    cfg.param<double>("joint2_max_accel", joint2_max_accel, joint2_max_accel, true,
        rcl_interfaces::msg::ParameterType::PARAMETER_DOUBLE,
        "Maximal acceleration of second joint.",
        "Default: 1.5");
    cfg.param<double>("joint2_max_decel", joint2_max_decel, joint2_max_decel, true,
        rcl_interfaces::msg::ParameterType::PARAMETER_DOUBLE,
    ...
    p_has_profile = true;
    p_pub_joint1_limits = cfg.create_publisher<moveit_msgs::msg::JointLimits>("joint1_limits", 1);
    p_pub_joint2_limits = cfg.create_publisher<moveit_msgs::msg::JointLimits>("joint2_limits", 1);
    p_pub_joint1_limits->publish(p_joint_limits_current.first);
    p_pub_joint2_limits->publish(p_joint_limits_current.second);
}

void PanTiltMotionProfile_ReceiveFSM::sendReportPanTiltMotionProfileAction(QueryPanTiltMotionProfile msg, Receive::Body::ReceiveRec transportData)
{
    /// Insert User Code HERE
    RCLCPP_DEBUG(logger, "send pantilt motion profile to %s", transportData.getAddress().str().c_str());
    sendJausMessage(p_motion_profile, transportData.getAddress());
}

void PanTiltMotionProfile_ReceiveFSM::setPanTiltMotionProfileAction(SetPanTiltMotionProfile msg, Receive::Body::ReceiveRec transportData)
{
    /// Insert User Code HERE
    RCLCPP_DEBUG(logger, "set new pantilt motion profile from %s", transportData.getAddress().str().c_str());
...
void PanTiltMotionProfile_ReceiveFSM::reset_motion_profile()
{
    RCLCPP_DEBUG(logger, "reset pantilt motion profile to defaults");
    p_motion_profile.getBody()->getPanTiltMotionProfileRec()->setJoint1MaxAccelerationRate(joint1_max_accel);
    p_motion_profile.getBody()->getPanTiltMotionProfileRec()->setJoint1MaxDecelerationRate(joint1_max_decel);
    p_motion_profile.getBody()->getPanTiltMotionProfileRec()->setJoint1MaxSpeed(joint1_max_speed);
    p_motion_profile.getBody()->getPanTiltMotionProfileRec()->setJoint2MaxAccelerationRate(joint2_max_accel);
...
bool PanTiltMotionProfile_ReceiveFSM::isControllingClient(Receive::Body::ReceiveRec transportData)
{
...
bool PanTiltMotionProfile_ReceiveFSM::panTiltMotionProfileExists()
{
    /// Insert User Code HERE
    return p_has_profile;
}

void PanTiltMotionProfile_ReceiveFSM::add_listener(iop::PanTiltMotionProfileListenerInterface* listener)
{
    if (listener != NULL) {
        std::vector<iop::PanTiltMotionProfileListenerInterface*>::iterator res = std::find(p_motion_listener.begin(), p_motion_listener.end(), listener);
        if (res == p_motion_listener.end()) {
            p_motion_listener.push_back(listener);
        }
    }
}

void PanTiltMotionProfile_ReceiveFSM::pNotifyListeners(JausAddress reporter, ReportPanTiltMotionProfile profile)
{
    for (unsigned int i = 0; i < p_motion_listener.size(); i++) {
        p_motion_listener[i]->motion_profile_received(reporter, profile);
    }
}
};
