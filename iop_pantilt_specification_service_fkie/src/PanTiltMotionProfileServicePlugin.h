...
#ifndef PANTILTMOTIONPROFILESERVICEPLUGIN_H
#define PANTILTMOTIONPROFILESERVICEPLUGIN_H

#include "urn_jaus_jss_manipulator_PanTiltMotionProfileService/PanTiltMotionProfileServiceService.h"
...
class DllExport PanTiltMotionProfileServicePlugin : public PluginInterface
{
public:
	PanTiltMotionProfileServicePlugin();

	JTS::Service* get_service();
	void create_service(JTS::JausRouter* jaus_router);

protected:
	urn_jaus_jss_manipulator_PanTiltMotionProfileService::PanTiltMotionProfileServiceService *p_my_service;
