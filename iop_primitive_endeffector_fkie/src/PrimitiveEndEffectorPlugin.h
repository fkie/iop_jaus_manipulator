...
#ifndef PRIMITIVEENDEFFECTORPLUGIN_H
#define PRIMITIVEENDEFFECTORPLUGIN_H

#include "urn_jaus_jss_manipulator_PrimitiveEndEffector/PrimitiveEndEffectorService.h"
...
class DllExport PrimitiveEndEffectorPlugin : public PluginInterface
{
public:
	PrimitiveEndEffectorPlugin();

	JTS::Service* get_service();
	void create_service(JTS::JausRouter* jaus_router);

protected:
	urn_jaus_jss_manipulator_PrimitiveEndEffector::PrimitiveEndEffectorService *p_my_service;
