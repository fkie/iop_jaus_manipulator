...
#ifndef MANIPULATORSPECIFICATIONSERVICEPLUGIN_H
#define MANIPULATORSPECIFICATIONSERVICEPLUGIN_H
...
class DllExport ManipulatorSpecificationServicePlugin : public PluginInterface
{
public:
	ManipulatorSpecificationServicePlugin();

	JTS::Service* get_service();
	void create_service(JTS::JausRouter* jaus_router);

protected:
	urn_jaus_jss_manipulator_ManipulatorSpecificationService::ManipulatorSpecificationServiceService *p_my_service;
