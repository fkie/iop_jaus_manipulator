...
#ifndef PANTILTJOINTPOSITIONDRIVERPLUGIN_H
#define PANTILTJOINTPOSITIONDRIVERPLUGIN_H
...
class DllExport PanTiltJointPositionDriverPlugin : public PluginInterface
{
public:
	PanTiltJointPositionDriverPlugin();

	JTS::Service* get_service();
	void create_service(JTS::JausRouter* jaus_router);

protected:
	urn_jaus_jss_manipulator_PanTiltJointPositionDriver::PanTiltJointPositionDriverService *p_my_service;
