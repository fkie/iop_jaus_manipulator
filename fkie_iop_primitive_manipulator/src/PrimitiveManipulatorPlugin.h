...
#ifndef PRIMITIVEMANIPULATORPLUGIN_H
#define PRIMITIVEMANIPULATORPLUGIN_H

#include "urn_jaus_jss_manipulator_PrimitiveManipulator/PrimitiveManipulatorService.h"
...
class DllExport PrimitiveManipulatorPlugin : public PluginInterface
{
public:
	PrimitiveManipulatorPlugin();

	JTS::Service* get_service();
	void create_service(JTS::JausRouter* jaus_router);

protected:
	urn_jaus_jss_manipulator_PrimitiveManipulator::PrimitiveManipulatorService *p_my_service;
