...
#include "urn_jaus_jss_manipulator_PrimitivePanTilt/PrimitivePanTiltService.h"
...
class DllExport PrimitivePanTiltPlugin : public PluginInterface
{
public:
	PrimitivePanTiltPlugin();

	JTS::Service* get_service();
	void create_service(JTS::JausRouter* jaus_router);

protected:
	urn_jaus_jss_manipulator_PrimitivePanTilt::PrimitivePanTiltService *p_my_service;
