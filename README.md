...
[![ros2](https://github.com/fkie/iop_jaus_manipulator/actions/workflows/main.yaml/badge.svg?branch=ros2)](https://github.com/fkie/iop_jaus_manipulator/actions/workflows/main.yaml)

### List of service plugins in this repository:

(ros1 only) [fkie_iop_manipulator_joint_position_sensor: ManipulatorJointPositionSensor](fkie_iop_manipulator_joint_position_sensor/README.md)  
(ros1 only) [fkie_iop_manipulator_specification_service: ManipulatorSpecificationService](fkie_iop_manipulator_specification_service/README.md)  
...
(ros1 only) [fkie_iop_primitive_endeffector: PrimitiveEndEffector](fkie_iop_primitive_endeffector/README.md)  
(ros1 only) [fkie_iop_primitive_manipulator: PrimitiveManipulator](fkie_iop_primitive_manipulator/README.md)  
(ros1 only) [fkie_iop_primitive_pantilt: PrimitivePanTilt](fkie_iop_primitive_pantilt/README.md)
